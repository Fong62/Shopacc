            ...
            <div class="table-responsive">
                <table id="datatable" class="table table-hover">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        // Nếu là admin thì hiển thị tất cả giao dịch
                        if($getUser['level'] == "admin") {
                            $query = $CMSNT->get_list("SELECT * FROM `cards` ORDER BY id ASC");
                        } else {
                        ...
                        <tr>
                            ...
                            <?php if($getUser['level'] =="admin"): ?>
                                <td>
                                    <?php if($row['username'] == $getUser['username']): ?>
                                        <span class="badge badge-info"><?=$row['username'];?></span>
                                    <?php else: ?>
                                        <?=$row['username'];?>
                                    <?php endif; ?>
                                </td>
